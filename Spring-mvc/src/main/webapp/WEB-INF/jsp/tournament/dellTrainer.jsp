...
<my:pagetemplate title="Add trainer">
    <jsp:attribute name="body">
           ...
           <form:form method="post" action="${pageContext.request.contextPath}/tournament/trainerDell"
                   modelAttribute="tournamentDell" cssClass="form-horizontal">
               
                <div class="form-group">
                <form:label path="tournamentDell" cssClass="col-sm-2 control-label">Tournament</form:label>
                    <div class="col-sm-10">
            ...
            <button class="btn btn-primary" type="submit">Remove trainer</button>
        </form:form>
